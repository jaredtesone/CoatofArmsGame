...
let levelFourState = function() {
	this.score = 0;
};

levelFourState.prototype.create = function() {
	
	level4Music = game.add.audio('level4Music');
	level4Music.play();
...
/*	this.bandit5 = new Enemy(1875, 1500, "bandit", "bandit", false);
	...
	text = game.add.text(0, 875, "Jose flies Don Quixote to the kings castle and waits outside while Don Quixote walks inside. \nUpon entering the throne room Don Quixote realizes something is wrong. There are no guards, just the king smirking at him.", {fill: "white", boundsAlignH: "center", boundsAlignV: "middle",strokeThickness: 2});
...
levelFourState.prototype.update = function() {
...
levelFourState.prototype.damagePlayer = function(enemy) {
...
levelFourState.prototype.attackEnemy = function(enemy, damage) {
...
levelFourState.prototype.target = function(enemy, attacking) {
	if (!this.player.alive)
		return;	
...
levelFourState.prototype.loadText = function() {
	...
	if (stageCounter === 1) {
		...
		text = game.add.text(0, 875, "Peter: Well “adventurer”, where is my scepter?", {fill: "white", boundsAlignH: "center", boundsAlignV: "middle"});
        this.button.revive();
        //this.player.tap = this.player.doubleTap = this.player.swipe = this.player.hold = this.player.drag = false;
	} else if (stageCounter === 3) {
		text = game.add.text(0, 875, "Don Quixote: I have heard you are an evil necromancer, there will be no scepter for you!", {fill: "white", boundsAlignH: "center", boundsAlignV: "middle"});
		//this.player.tap = this.player.doubleTap = this.player.swipe = this.player.hold = this.player.drag = false;
	} else if (stageCounter === 4) {
		text = game.add.text(0, 875, "Peter: *shrieks* HOW DARE YOU DEFY ME YOU MORTAL!", {fill: "white", boundsAlignH: "center", boundsAlignV: "middle"});
		//this.player.tap = this.player.doubleTap = this.player.swipe = this.player.hold = this.player.drag = false;
	} else if (stageCounter === 5) {
		text = game.add.text(0, 875, "The air around Peter begins to darken, and Juan realized he made the right decision. \nHe calls out, “JOSE NOW” and the dragon fires a fireball through a window into the king, seriously wounding him, before flying off.", {fill: "white", boundsAlignH: "center", boundsAlignV: "middle"});
		//this.player.tap = this.player.doubleTap = this.player.swipe = this.player.hold = this.player.drag = false;
